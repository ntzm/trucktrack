...
var api = {
    locationCache: {},
    getGameLocations: function getGameLocations(game, callback) {
        if (api.locationCache.hasOwnProperty(game)) {
            callback(api.locationCache[game]);
        }

        $.get('/api/games/' + game + '/locations').done(function (locations) {
...
$(document).ready(function () {
    ...
    var $gameLocationContainer = $('#location-container');
...
function renderGameLocations(maps, $el) {
    var html = '<div class="well"><div class="row">';
    ...
    types.forEach(function (type) {
        var oldValue = $('#old-' + type.slug).val();

        html += '<div class="col-sm-6">' + '<div class="form-group">' + '<label for="from" class="control-label">' + type.display + '</label>' + '<select id="' + type.slug + '" class="form-control single-selector-search" name="' + type.slug + '" required>' + '<option></option>';
