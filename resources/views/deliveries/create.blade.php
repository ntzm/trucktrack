        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <div class="form-group{{ $errors->has('fuel_used') ? ' has-error' : '' }}">
                    ...
                    <div class="input-group">
                        <input id="fuel_used" type="number" class="form-control" name="fuel_used" value="{{ old('fuel_used') }}" min="0" max="100000" required>
        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <div class="form-group{{ $errors->has('trailer_damage') ? ' has-error' : '' }}">
                    ...
                    <div class="input-group">
                        <input id="trailer_damage" type="number" class="form-control" name="trailer_damage" value="{{ old('trailer_damage') }}" min="0" max="100" required>
                        <div class="input-group-addon">%</div>
                    </div>
